...
def main(args):
    ...
    # args.eval_logdir = f"./evaluation/adversarial_white/{args.attack_type_list[0]}/attack_eps{args.attack_epsilon}/{ENV_NAME_MAPPING[args.dataset]}"
    args.eval_logdir = f"./evaluation/adversarial_gray/{args.attack_type_list[0]}/attack_eps{args.attack_epsilon}/{ENV_NAME_MAPPING[args.dataset]}"
    ...
    #              (MEAN([unorm_score_attack[0]]), np.std(unorm_score_attack, axis=1).squeeze(),
    #               MEDIAN([unorm_score_attack[0]]), IQM([unorm_score_attack[0]]), OG([unorm_score_attack[0]]),
    #               n_seeds))
